...
const NearbyMap: React.FC = () => {
  ...
  return (
    <section className="nearby-map relative w-full bg-gradient-to-br from-slate-50 via-white to-emerald-50 overflow-hidden min-h-screen flex flex-col">
      ...
      <div className="relative flex-grow w-full">
        <ScrollArea className="absolute inset-0">
          <div className="relative w-full">
            <div className={`relative w-full ${isMobile ? 'h-[140vh]' : 'h-[110vh]'} bg-transparent`}>
      ...
      <div className={`absolute ${isMobile ? 'bottom-4 right-4' : 'bottom-6 right-6 md:right-10'} bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200/60 ${isMobile ? 'px-3 py-2' : 'px-6 md:px-8 py-4 md:py-5'} shadow-xl z-30 transition-all duration-1200 ${
